...
class User_manager(models.Manager):
    def reg_validator(self, postData):
        ...
        if len(postData['parent_name']) < 2:
            errors['parent_name'] = "Parent's name must be at least 2 characters."
        if not postData['parent_name'].isalpha():
            errors['parent_name'] = "Parent's name can only contain letters"
